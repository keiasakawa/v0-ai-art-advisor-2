...
const roleConfig: Record<
  UserRole,
  { label: string; icon: typeof ShoppingBag; color: string; href: string }
> = {
  collector_buyer: {
    label: "Buyer",
    icon: ShoppingBag,
...
export function Navigation() {
  ...
  const activeRoleConfig = user?.activeRole
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="gap-2 pl-2 pr-3">
                    ...
                    {activeRoleConfig && (
                      <Badge
                        variant="secondary"
                        className={cn("text-xs", activeRoleConfig.color)}
                      >
                  ...
                  <div className="flex items-center gap-3 pb-4 border-b border-border">
                    ...
                    <div>
                      ...
                      {activeRoleConfig && (
                        <Badge
                          variant="secondary"
                          className={cn("text-xs mt-1", activeRoleConfig.color)}
                        >
                          {activeRoleConfig.label}
                        </Badge>
                      )}
